...
_ = MessageFactory('pas.plugins.identitymanager')
...
LOGIN_TEMPLATE_IDS = (
    'login login_success login_password login_failed login_form logged_in '
...
ANNOTATION_KEYS = {
    'authomatic': 'pas.plugins.identitymanager.authomatic.social'
}
